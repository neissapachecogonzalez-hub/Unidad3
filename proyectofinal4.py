...
def mostrar_ticket(producto, precio, cantidad, total):
  ...
  " *** PUNTO DE VENTA ***n"
  "--------------------------------------n"
  f"Fecha: {fecha_hora}n"
  "--------------------------------------n"
  f"Producto: {producto}n"
  f"Precio: ${precio}n"
  f"Cantidad: {cantidad}n"
  "--------------------------------------n"
  f"TOTAL: ${total}n"
  "--------------------------------------n"
  " ¡GRACIAS POR SU COMPRA!n"
  )
...
def abrir_acerca_de(): 
   ...
   texto = (
        "Proyecto escolar desarrollado en Python utilizando Tkinter.\n\n"
        "FUNCIONALIDADES:\n"
        "• Registro de productos.\n"
        "• Registro y cálculo automático de ventas.\n"
        "• Generación de tickets con fecha y hora.\n"
        "• Reportes de ventas acumuladas.\n"
        "• Manejo de archivos para almacenar la información.\n\n"
        "Desarrollado por:\n"
        "Neissa Cindi Pacheco González\n"
        "Guiado por una plataforma digital.\n\n"
        "Versión 1.0 – 2025"
    )
